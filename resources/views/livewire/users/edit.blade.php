                ...
                <form>
                                    ...
                                    <div class="mt-5 md:mt-0 md:col-span-2">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input name="email" wire:model="email" id="email" class="bg-gray-100 mt-1 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" readonly>
                                            </div>  
                                        </div>    
                                        <div class="grid grid-cols-6 gap-6 mt-3">
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                @error('password')
                                                    ...
                                                    <br>
                                                @enderror
                                                <span class="text-gray-500 text-sm font-medium">Dejar en blanco si no se va a actualizar</span>
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                            <button wire:click="update({{ $user_id }})" type="button" class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-green-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                                Actualizar
                            </button>
                        </span>
